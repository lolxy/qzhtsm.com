...
$configs= array(
		...
		//'APP_GROUP_LIST'        => 'Admin,Htsm,Asset,Api,Member,Wx,Toptic,Strap',      // 项目分组设定,多个组之间用逗号分隔,例如'Home,Admin'

		'MODULE_ALLOW_LIST'  => array('Admin','Htsm','Asset','Api','User','Wx','Comment','Qiushi','Tpl','Topic','Install','Bug','Better','Pay'),

 		'TMPL_DETECT_THEME'     => false,       // 自动侦测模板主题

 		'TMPL_TEMPLATE_SUFFIX'  => '.html',     // 默认模板文件后缀

		'DEFAULT_MODULE'        =>  'Htsm',  // 默认模块
		...
		'SP_DEFAULT_THEME'		=> 'qzhtsm',       // 前台模板文件
		...
		'SP_ADMIN_DEFAULT_THEME'=> 'myhome',       // 各个项目后台模板文件
