...
<div class="container tc-main">
	...
	<div class="row">
        <div class="pg-opt pin">
        	...
        	<?php if(!empty($keyword)): ?><h2 style="text-indent:15px;">关键字 '<?php echo ($keyword); ?>' 的搜索结果</h2>
            
            <?php else: ?>
            
            <h2 style="text-indent:15px;">全部搜索结果</h2><?php endif; ?>
            
            <p>共 <b><?php echo ($result['count']); ?></b>条结果</p>
		...
		<div class="col-lg-9 col-xs-12">
        	...
        	<div class="searchs-box">
                ...
                <form method="post" class="form-inline" action="<?php echo U('htsm/search/index');?>">
                    ...
                    <input type="text" class="textbox form-control" placeholder="请输入要搜索的关键字" name="keyword" value="<?php echo I('get.keyword');?>"/>
           ...
           <div class="clearfix"></div>
				...
				<div class="list-boxes">
					...
					<div>
						...
						<div class="pull-left">
							...
							<a href="javascript:;">浏览量：&nbsp;<i class="fa fa-eye"></i>&nbsp;<span><?php echo ($vo["post_hits"]); ?></span></a>

							</div>

						</div>

						<a class="btn btn-primary pull-right" href="<?php echo leuu('article/index',array('id'=>$vo['tid']));?>">查看更多</a>
			...
			<?php if(!empty($result['page'])): ?><div class="pagination">
