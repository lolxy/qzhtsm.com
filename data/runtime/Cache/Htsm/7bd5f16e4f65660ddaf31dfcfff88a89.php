    ...
    <div class="row">
		...
		<div class="col-lg-9 col-xs-12">
			...
			<div class="lists-box">
                ...
                <p style="height:30px;">暂无数据！谢谢关注！</p><?php endif; ?>
		...
		<div class="col-lg-3 col-xs-12 left-box">  
        	...
        	<div class="tc-box ywbox">
				<?php
 $term_id=17; $terms=sp_get_child_terms($term_id ); ?>
        	...
        	<div class="tc-box hotsnewbox">
	        	...
	        	<div class="ranking">
	        		...
	        		<?php $cid=I('get.id'); $hot_articles=sp_sql_posts("cid:$cid;field:post_title,post_excerpt,tid,smeta;order:post_hits desc;limit:5;"); ?>
